...
time = datetime.now() # Засекаем время

with open('hacker_secret.txt') as f:

    lines = f.readlines() 
    hacker_secret_to_hack = lines[0] # Тут программа считывает, что именно вы загадали
    ...
    print("Времени ушло: " + str(datetime.now() - time))